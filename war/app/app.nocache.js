...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "app" because\n';
 ...
 * "/app.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['app'].superdevmode = true;

  var expectedSuffix = '/app.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + app + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:app';
  var devModeSessionKey = '__gwtDevModeSession:app';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/app/app.nocache.js';
  ...
  $wnd.__gwt_activeModules['app'].canRedirect = true;
  $wnd.__gwt_activeModules['app'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/app?user.agent=' + ua + '&_callback=' + callback;
